...
void setupHero(void) {
    sprite_init(&hero, blocks[0].x, blocks[0].y - 8, HERO_WIDTH, HERO_HEIGHT, hero_img);
}
...
//     bool heroStand = isHeroStanding();
//     if (heroStand) {
//         if (moveRight && (hero.y == row[0] || hero.y == row[2])) {
//             hero.dx = 0.4;
//         } 
//         if (moveRight && hero.y == row[1]) {
//             hero.dx = 0.6;
//         } 
//         if (moveLeft && hero.y == row[1]) {
//             hero.dx = -0.4;
//         } 
//         if (moveLeft && (hero.y == row[0] || hero.y == row[2])) {
//             hero.dx = -1;
//         }
