...
//                 double y = (1+row_num) * row_height + heroHeight;
//                 //int8_t bitmap = isSafe? safe_img: forbidden_img;
//                 if (isSafe) {
//                     sprite_init(&block[block_ctr], x, y, blockWidth, blockHeight, safe_img);
//                 } else {
//                     sprite_init(&block[block_ctr], x, y, blockWidth, blockHeight, forbidden_img);
//                 }
